...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Content
    ref={ref}
    className={cn(
      "relative z-[999] slide-in-from-top-1 animate-in flex flex-col border bg-background border-border rounded shadow-md shadow-foreground/25 min-w-[200px] p-1 my-1",
      className
    )}
    {...props}
  />
